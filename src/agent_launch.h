...
// there is truthful. The kernel child owns configuration validation,
// duplicate defense, workdir lease, signal cleanup, and lifetime; this
// function tracks no PID and never waits on or manages the spawned process.
